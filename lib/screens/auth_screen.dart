...
class _AuthScreenState extends State<AuthScreen>
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      ...
      if (mounted) {
        setState(
          () => _errorMessage = AuthService.errorMessage(e as Exception),
        );
      }
    } finally {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Sign In', style: TextStyle(color: OneDarkColors.fg)),
              ...
              children: [
                ...
                if (_errorMessage != null)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: OneDarkColors.red.withValues(alpha: 0.2),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: OneDarkColors.cyan),
                    ),
                  ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Password',
                    labelStyle: TextStyle(color: OneDarkColors.fgDim),
                    prefixIcon: Icon(Icons.lock, color: OneDarkColors.cyan),
